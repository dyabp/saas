...
namespace Dyabp.Saas
{
    ...
    public class SaasTenantController : AbpController, ISaasTenantAppService //TODO: Throws exception on validation if we inherit from Controller
    {
        ...
        [HttpPost]
        public virtual Task<SaasTenantDto> CreateAsync(CreateSaasTenantDto input)
        {
            //ValidateModel();
        ...
        [HttpPut]
        [Route("{id}")]
        public virtual Task<SaasTenantDto> UpdateAsync(Guid id, UpdateSaasTenantDto input)
        {
